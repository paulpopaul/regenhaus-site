<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                ...
                'title' => 'Community, Neighborhood, Suburb, District, School District, Building or Borough?',
                'default' => 'community',
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'desc'   => __( 'Set this up if you\'d like to display "What\'s Nearby?" information on your listings such as restaurants, stores, schools, coffee shops, etc&hellip;.', 'contempo' ),
        'customizer_width' => '450px',
        'fields'           => array(
            array (
                'id' => 'places-app-info',
