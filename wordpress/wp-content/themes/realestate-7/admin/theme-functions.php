...
if(!function_exists('ct_init_scripts')) {
	function ct_init_scripts() {
		...
		if(is_page_template('template-submit-listing.php') || (is_page_template('template-edit-listing'))) {
			...
			wp_enqueue_script('gmaps', '//maps.google.com/maps/api/js' . $google_maps_api_key_output . '&v=3.30', '', '1.0', false);
		}
...
if(!function_exists('ct_multi_contact_us_map')) {
	function ct_multi_contact_us_map() { 
		...
		var ctMapGlobal = {
			...
			mapType: "<?php $ct_gmap_type = isset( $ct_options['ct_contact_map_type'] ) ? $ct_options['ct_contact_map_type']: '';  echo esc_html($ct_gmap_type); ?>"
		}
